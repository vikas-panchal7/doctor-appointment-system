							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									...
									<div class="footer-about-content">
										<p>Discover the best doctors,hospital at your Fingerprint.</p>
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										...
										<li><a href=""><i class="fas fa-angle-double-right"></i> Login</a></li>
										<li><a href=""><i class="fas fa-angle-double-right"></i> View Appointments</a></li>
										<li><a href=""><i class="fas fa-angle-double-right"></i>Prescription</a></li>
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										...
										<li><a href=""><i class="fas fa-angle-double-right"></i>Login</a></li>
										<li><a href=""><i class="fas fa-angle-double-right"></i> View Appointments</a></li>
										<li><a href=""><i class="fas fa-angle-double-right"></i>Add Doctor</a></li>
										<li><a href=""><i class="fas fa-angle-double-right"></i>Hospital Dashboards</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->

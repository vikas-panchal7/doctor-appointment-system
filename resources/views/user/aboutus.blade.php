			...
			<section class="section section-specialities">
				<div class="container-fluid">
					<div class="section-header text-center">
						<h2>Doctors and Specialities</h2>
						<p class="sub-title"></p>
					</div>
				   ...
				   <div class="row">
						<div class="col-lg-4">
							<div class="section-header ">
								<h2>Book Doctors</h2>
								<p> Book a doctor for you + family members viaDoccure in minutes.</p>
							</div>
							<div class="about-content">
								<p>Consult with the best doctor practicing with Hospitals near you, ranked among the best ... Book an Instant Online Appointment Now through Doccure..</p>
								<p>Best doctors for online consultation. Available now video consultations , Booking appointments, homecare, health queries / advices, Medicines home delivery ...</p>					
